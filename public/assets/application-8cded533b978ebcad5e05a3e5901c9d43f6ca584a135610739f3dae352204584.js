    ...
    var self = {
        ...
        faye: function (e) {
            if (self.fayeClient)e(self.fayeClient); else if (self.fayeCallbacks.push(e), self.subscriptions.server && !self.connecting) {
                ...
                t.type = "text/javascript", t.src = self.subscriptions.server + ".js", t.onload = self.connectToFaye, doc.documentElement.appendChild(t)
            }
        },
        ...
        sign: function (e) {
            self.subscriptions.server || (self.subscriptions.server = e.server), self.subscriptions[e.channel] = e, self.faye(function (t) {
...
!function (e, t) {
    ...
    function v(e, t, n, r, i) {
        for (var o, a, s, l, u, c, d, f = e.length, v = p(t), y = [], b = 0; f > b; b++)if (a = e[b], a || 0 === a)if ("object" === pe.type(a))pe.merge(y, a.nodeType ? [a] : a); else if (Ue.test(a)) {
            for (l = l || v.appendChild(t.createElement("div")), u = (Be.exec(a) || ["", ""])[1].toLowerCase(), d = Xe[u] || Xe._default, l.innerHTML = d[1] + pe.htmlPrefilter(a) + d[2], o = d[0]; o--;)l = l.lastChild;
            if (!de.leadingWhitespace && $e.test(a) && y.push(t.createTextNode($e.exec(a)[0])), !de.tbody)for (a = "table" !== u || Ge.test(a) ? "<table>" !== d[1] || Ge.test(a) ? 0 : l : l.firstChild, o = a && a.childNodes.length; o--;)pe.nodeName(c = a.childNodes[o], "tbody") && !c.childNodes.length && a.removeChild(c);
    ...
    function N(e, t, n, r) {
        ...
        if (d && (u = v(t, e[0].ownerDocument, !1, e, r), i = u.firstChild, 1 === u.childNodes.length && (u = i), i || r)) {
            for (s = pe.map(h(u, "script"), E), a = s.length; d > c; c++)o = u, c !== f && (o = pe.clone(o, !0, !0), a && pe.merge(s, h(o, "script"))), n.call(e[c], o, c);
            if (a)for (l = s[s.length - 1].ownerDocument, pe.map(s, C), c = 0; a > c; c++)o = s[c], We.test(o.type || "") && !pe._data(o, "globalEval") && pe.contains(l, o) && (o.src ? pe._evalUrl && pe._evalUrl(o.src) : pe.globalEval((o.text || o.textContent || o.innerHTML || "").replace(ot, "")));
            u = i = null
        }
        return e
    }
    ...
    function H(e) {
        if (e in Ct)return e;
        for (var t = e.charAt(0).toUpperCase() + e.slice(1), n = Et.length; n--;)if (e = Et[n] + t, e in Ct)return e
    }

    function _(e, t) {
        for (var n, r, i, o = [], a = 0, s = e.length; s > a; a++)r = e[a], r.style && (o[a] = pe._data(r, "olddisplay"), n = r.style.display, t ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && Me(r) && (o[a] = pe._data(r, "olddisplay", D(r.nodeName)))) : (i = Me(r), (n && "none" !== n || !i) && pe._data(r, "olddisplay", i ? n : pe.css(r, "display"))));
    ...
    function B(e, t, n) {
        ...
        if (pe.isEmptyObject(f))"inline" === ("none" === u ? D(e.nodeName) : u) && (p.display = u); else {
            ...
            for (r in f)a = I(h ? m[r] : 0, r, d), r in m || (m[r] = a.start, h && (a.end = a.start, a.start = "width" === r || "height" === r ? 1 : 0))
        }
    }
    ...
    function $(e, t, n) {
        var r, i, o = 0, a = $.prefilters.length, s = pe.Deferred().always(function () {
            ...
            if (i)return !1;
            for (var t = kt || M(), n = Math.max(0, u.startTime + u.duration - t), r = n / u.duration || 0, o = 1 - r, a = 0, l = u.tweens.length; l > a; a++)u.tweens[a].run(o);
        ...
        for (W(c, u.opts.specialEasing); a > o; o++)if (r = $.prefilters[o].call(u, e, c, u.opts))return pe.isFunction(r.stop) && (pe._queueHooks(u.elem, u.opts.queue).stop = pe.proxy(r.stop, r)), r;
    ...
    var ne = [], re = e.document, ie = ne.slice, oe = ne.concat, ae = ne.push, se = ne.indexOf, le = {}, ue = le.toString, ce = le.hasOwnProperty, de = {}, fe = "1.12.1", pe = function (e, t) {
        ...
        function (e) {
            ...
            function p(e, t, n) {
                ...
                return t.first ? function (t, n, o) {
                    ...
                    if (a) {
                        ...
                        if (u = t[P] || (t[P] = {}), l = u[t.uniqueID] || (u[t.uniqueID] = {}), (s = l[r]) && s[0] === B && s[1] === o)return c[2] = s[2];
            ...
            function y(e) {
                for (var t, n, r, i = e.length, o = T.relative[e[0].type], a = o || T.relative[" "], s = o ? 1 : 0, l = p(function (e) {
                    ...
                    if (n = T.filter[e[s].type].apply(null, e[s].matches), n[P]) {
                        ...
                        return v(s > 1 && h(c), s > 1 && f(e.slice(0, s - 1).concat({value: " " === e[s - 2].type ? "*" : ""})).replace(se, "$1"), n, r > s && y(e.slice(s, r)), i > r && y(e = e.slice(r)), i > r && f(e))
                    }
                    c.push(n)
                }
                return h(c)
            ...
            function b(e, n) {
                var i = n.length > 0, o = e.length > 0, a = function (r, a, s, l, u) {
                    var c, d, f, p = 0, h = "0", m = r && [], v = [], y = j, b = r || o && T.find.TAG("*", u), x = B += null == y ? 1 : Math.random() || .1, w = b.length;
                    for (u && (j = a === H || a || u); h !== w && null != (c = b[h]); h++) {
                        if (o && c) {
                            for (d = 0, a || c.ownerDocument === H || (L(c), s = !q); f = e[d++];)if (f(c, a || H, s)) {
                                l.push(c);
                                break
                            }
                            u && (B = x)
            ...
            var x, w, T, E, C, k, S, N, j, A, D, L, H, _, q, F, R, O, M, P = "sizzle" + 1 * new Date, I = e.document, B = 0, W = 0, $ = n(), z = n(), X = n(), U = function (e, t) {
                return e === t && (D = !0), 0
            }, G = 1 << 31, V = {}.hasOwnProperty, Y = [], Q = Y.pop, J = Y.push, K = Y.push, Z = Y.slice, ee = function (e, t) {
            ...
            w = t.support = {}, C = t.isXML = function (e) {
                ...
                return r !== H && 9 === r.nodeType && r.documentElement ? (H = r, _ = H.documentElement, q = !C(H), (n = H.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Te, !1) : n.attachEvent && n.attachEvent("onunload", Te)), w.attributes = i(function (e) {
                    return e.className = "i", !e.getAttribute("className")
                }), w.getElementsByTagName = i(function (e) {
                    return e.appendChild(H.createComment("")), !e.getElementsByTagName("*").length
                }), w.getElementsByClassName = ge.test(H.getElementsByClassName), w.getById = i(function (e) {
                    return _.appendChild(e).id = P, !H.getElementsByName || !H.getElementsByName(P).length
                ...
                }, R = [], F = [], (w.qsa = ge.test(H.querySelectorAll)) && (i(function (e) {
                    _.appendChild(e).innerHTML = "<a id='" + P + "'></a><select id='" + P + "-\r\\' msallowcapture=''><option selected=''></option></select>", e.querySelectorAll("[msallowcapture^='']").length && F.push("[*^$]=" + ne + "*(?:''|\"\")"), e.querySelectorAll("[selected]").length || F.push("\\[" + ne + "*(?:value|" + te + ")"), e.querySelectorAll("[id~=" + P + "-]").length || F.push("~="), e.querySelectorAll(":checked").length || F.push(":checked"), e.querySelectorAll("a#" + P + "+*").length || F.push(".#.+[+~]")
                }), i(function (e) {
                    var t = H.createElement("input");
                    t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[name=d]").length && F.push("name" + ne + "*[*^$|!~]?="), e.querySelectorAll(":enabled").length || F.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), F.push(",.*:")
                })), (w.matchesSelector = ge.test(O = _.matches || _.webkitMatchesSelector || _.mozMatchesSelector || _.oMatchesSelector || _.msMatchesSelector)) && i(function (e) {
                    w.disconnectedMatch = O.call(e, "div"), O.call(e, "[s!='']:x"), R.push("!=", oe)
                }), F = F.length && new RegExp(F.join("|")), R = R.length && new RegExp(R.join("|")), t = ge.test(_.compareDocumentPosition), M = t || ge.test(_.contains) ? function (e, t) {
                    ...
                    return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === H || e.ownerDocument === I && M(I, e) ? -1 : t === H || t.ownerDocument === I && M(I, t) ? 1 : A ? ee(A, e) - ee(A, t) : 0 : 4 & n ? -1 : 1)
                } : function (e, t) {
                    if (e === t)return D = !0, 0;
                ...
                if ((e.ownerDocument || e) !== H && L(e), n = n.replace(ce, "='$1']"), w.matchesSelector && q && !X[n + " "] && (!R || !R.test(n)) && (!F || !F.test(n)))try {
                    var r = O.call(e, n);
                ...
                var n = T.attrHandle[t.toLowerCase()], r = n && V.call(T.attrHandle, t.toLowerCase()) ? n(e, t, !q) : void 0;
                        ...
                        return 1 === r && 0 === i ? function (e) {
                            ...
                            if (g) {
                                ...
                                if (h = [a ? g.firstChild : g.lastChild], a && y) {
                                    for (f = g, d = f[P] || (f[P] = {}), c = d[f.uniqueID] || (d[f.uniqueID] = {}), u = c[e] || [], p = u[0] === B && u[1], b = p && u[2], f = p && g.childNodes[p]; f = ++p && f && f[m] || (b = p = 0) || h.pop();)if (1 === f.nodeType && ++b && f === t) {
                                        c[e] = [B, p, b];
                                        break
                                    }
                                } else if (y && (f = t, d = f[P] || (f[P] = {}), c = d[f.uniqueID] || (d[f.uniqueID] = {}), u = c[e] || [], p = u[0] === B && u[1], b = p), b === !1)for (; (f = ++p && f && f[m] || (b = p = 0) || h.pop()) && ((s ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++b || (y && (d = f[P] || (f[P] = {}), c = d[f.uniqueID] || (d[f.uniqueID] = {}), c[e] = [B, b]), f !== t)););
            ...
            return d.prototype = T.filters = T.pseudos, T.setFilters = new d, k = t.tokenize = function (e, n) {
                ...
                return (u || S(e, d))(r, t, !q, n, !t || ye.test(e) && c(t.parentNode) || t), n
    ...
    var be = function (e, t, n) {
        ...
        return n
    }, we = pe.expr.match.needsContext, Te = /^<([\w-]+)\s*\/?>(?:<\/\1>|)$/, Ee = /^.[^:#\[\.,]*$/;
    ...
    var Ce, ke = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, Se = pe.fn.init = function (e, t, n) {
        var r, i;
        if (!e)return this;
    ...
    pe.fn.ready = function (e) {
        ...
        isReady: !1, readyWait: 1, holdReady: function (e) {
            ...
            (e === !0 ? --pe.readyWait : pe.isReady) || (pe.isReady = !0, e !== !0 && --pe.readyWait > 0 || (De.resolveWith(re, [pe]), pe.fn.triggerHandler && (pe(re).triggerHandler("ready"), pe(re).off("ready"))))
        }
    ...
    var Fe = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, Re = new RegExp("^(?:([+-])=|)(" + Fe + ")([a-z%]*)$", "i"), Oe = ["Top", "Right", "Bottom", "Left"], Me = function (e, t) {
    ...
    }, Ie = /^(?:checkbox|radio)$/i, Be = /<([\w:-]+)/, We = /^$|\/(?:java|ecma)script/i, $e = /^\s+/, ze = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|dialog|figcaption|figure|footer|header|hgroup|main|mark|meter|nav|output|picture|progress|section|summary|template|time|video";
    !function () {
    ...
    var Ve = /^(?:input|select|textarea)$/i, Ye = /^key/, Qe = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, Je = /^(?:focusinfocus|focusoutblur)$/, Ke = /^([^.]*)(?:\.(.+)|)/;
    pe.event = {
        global: {},
        add: function (e, t, n, r, i) {
            ...
            if (g) {
                ...
                }, c.elem = e), t = (t || "").match(Ae) || [""], s = t.length; s--;)o = Ke.exec(t[s]) || [], p = m = o[1], h = (o[2] || "").split(".").sort(), p && (u = pe.event.special[p] || {}, p = (i ? u.delegateType : u.bindType) || p, u = pe.event.special[p] || {}, d = pe.extend({
                    type: p, origType: m, data: r, handler: n, guid: n.guid,
                    selector: i, needsContext: i && pe.expr.match.needsContext.test(i), namespace: h.join(".")
        ...
        remove: function (e, t, n, r, i) {
            ...
            if (g && (c = g.events)) {
                for (t = (t || "").match(Ae) || [""], u = t.length; u--;)if (s = Ke.exec(t[u]) || [], p = m = s[1], h = (s[2] || "").split(".").sort(), p) {
        ...
        fix: function (e) {
            ...
            for (a || (this.fixHooks[i] = a = Qe.test(i) ? this.mouseHooks : Ye.test(i) ? this.keyHooks : {}), r = a.props ? this.props.concat(a.props) : this.props, e = new pe.Event(o), t = r.length; t--;)n = r[t], e[n] = o[n];
    ...
    pe.extend({
        ...
        domManip: N, detach: function (e) {
            ...
            return Pe(this, function (e) {
                ...
                if ("string" == typeof e && !nt.test(e) && (de.htmlSerialize || !et.test(e)) && (de.leadingWhitespace || !$e.test(e)) && !Xe[(Be.exec(e) || ["", ""])[1].toLowerCase()]) {
    ...
    var lt, ut = {
        HTML: "block",
        BODY: "block"
    }, ct = /^margin/, dt = new RegExp("^(" + Fe + ")(?!px)[a-z%]+$", "i"), ft = function (e, t, n, r) {
        var i, o, a = {};
    ...
    var vt = /alpha\([^)]*\)/i, yt = /opacity\s*=\s*([^)]*)/i, bt = /^(none|table(?!-c[ea]).+)/, xt = new RegExp("^(" + Fe + ")(.*)$", "i"), wt = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    }, Tt = {
        letterSpacing: "0",
        fontWeight: "400"
    }, Et = ["Webkit", "O", "Moz", "ms"], Ct = re.createElement("div").style;
    pe.extend({
        cssHooks: {
            opacity: {
                get: function (e, t) {
        ...
        pe.cssHooks[t] = {
            get: function (e, n, r) {
                ...
                var i = r && ht(e);
                return q(e, n, r ? F(e, t, r, de.boxSizing && "border-box" === pe.css(e, "boxSizing", !1, i), i) : 0)
            }
        }
    ...
    pe.fn.extend({
        val: function (e) {
            var t, n, r, i = this[0];
            {
                ...
                if (i)return t = pe.valHooks[i.type] || pe.valHooks[i.nodeName.toLowerCase()], t && "get"in t && void 0 !== (n = t.get(i, "value")) ? n : (n = i.value, "string" == typeof n ? n.replace(At, "") : null == n ? "" : n)
            }
        }
    }), pe.extend({
        valHooks: {
            option: {
                ...
                get: function (e) {
                    for (var t, n, r = e.options, i = e.selectedIndex, o = "select-one" === e.type || 0 > i, a = o ? null : [], s = o ? i + 1 : r.length, l = 0 > i ? s : o ? i : 0; s > l; l++)if (n = r[l], (n.selected || l === i) && (de.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !pe.nodeName(n.parentNode, "optgroup"))) {
    ...
    var Dt, Lt, Ht = pe.expr.attrHandle, _t = /^(?:checked|selected)$/i, qt = de.getSetAttribute, Ft = de.input;
    pe.fn.extend({
        attr: function (e, t) {
        ...
        attr: function (e, t, n) {
            ...
            if (o && 1 === e.nodeType)for (; n = o[i++];)r = pe.propFix[n] || n, pe.expr.match.bool.test(n) ? Ft && qt || !_t.test(n) ? e[r] = !1 : e[pe.camelCase("default-" + n)] = e[r] = !1 : pe.attr(e, n, ""), e.removeAttribute(qt ? n : r)
        }
    }), Lt = {
        set: function (e, t, n) {
            return t === !1 ? pe.removeAttr(e, n) : Ft && qt || !_t.test(n) ? e.setAttribute(!qt && pe.propFix[n] || n, n) : e[pe.camelCase("default-" + n)] = e[n] = !0, n
        }
    }, pe.each(pe.expr.match.bool.source.match(/\w+/g), function (e, t) {
        var n = Ht[t] || pe.find.attr;
        Ft && qt || !_t.test(t) ? Ht[t] = function (e, t, r) {
            var i, o;
    ...
    pe.fn.extend({
        addClass: function (e) {
            ...
            if ("string" == typeof e && e)for (t = e.match(Ae) || []; n = this[l++];)if (i = z(n), r = 1 === n.nodeType && (" " + i + " ").replace(Mt, " ")) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : pe.isFunction(e) ? this.each(function (n) {
                ...
                var t, r, i, o;
                if ("string" === n)for (r = 0, i = pe(this), o = e.match(Ae) || []; t = o[r++];)i.hasClass(t) ? i.removeClass(t) : i.addClass(t); else void 0 !== e && "boolean" !== n || (t = z(this), t && pe._data(this, "__className__", t), pe.attr(this, "class", t || e === !1 ? "" : pe._data(this, "__className__") || ""))
            })
        }, hasClass: function (e) {
            var t, n, r = 0;
            for (t = " " + e + " "; n = this[r++];)if (1 === n.nodeType && (" " + z(n) + " ").replace(Mt, " ").indexOf(t) > -1)return !0;
            return !1
        }
    ...
    var Pt = e.location, It = pe.now(), Bt = /\?/, Wt = /(,)|(\[|{)|(}|])|"(?:[^"\\\r\n]|\\["\\\/bfnrt]|\\u[\da-fA-F]{4})*"\s*:?|true|false|null|-?(?!0\d)\d+(?:\.\d+|)(?:[eE][+-]?\d+|)/g;
    ...
    var $t = /#.*$/, zt = /([?&])_=[^&]*/, Xt = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, Ut = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Gt = /^(?:GET|HEAD)$/, Vt = /^\/\//, Yt = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, Qt = {}, Jt = {}, Kt = "*/".concat("*"), Zt = Pt.href, en = Yt.exec(Zt.toLowerCase()) || [];
    pe.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ...
        ajax: function (t, n) {
            function r(t, n, r, i) {
                var o, d, y, b, w, E = n;
                2 !== x && (x = 2, l && e.clearTimeout(l), c = void 0, s = i || "", T.readyState = t > 0 ? 4 : 0, o = t >= 200 && 300 > t || 304 === t, r && (b = V(f, T, r)), b = Y(f, b, T, o), o ? (f.ifModified && (w = T.getResponseHeader("Last-Modified"), w && (pe.lastModified[a] = w), w = T.getResponseHeader("etag"), w && (pe.etag[a] = w)), 204 === t || "HEAD" === f.type ? E = "nocontent" : 304 === t ? E = "notmodified" : (E = b.state, d = b.data, y = b.error, o = !y)) : (y = E, !t && E || (E = "error", 0 > t && (t = 0))), T.status = t, T.statusText = (n || E) + "", o ? m.resolveWith(p, [d, E, T]) : m.rejectWith(p, [T, E, y]), T.statusCode(v), v = void 0, u && h.trigger(o ? "ajaxSuccess" : "ajaxError", [T, f, o ? d : y]), g.fireWith(p, [T, E]), u && (h.trigger("ajaxComplete", [T, f]), --pe.active || pe.event.trigger("ajaxStop")))
            }
            ...
            if (m.promise(T).complete = g.add, T.success = T.done, T.error = T.fail, f.url = ((t || f.url || Zt) + "").replace($t, "").replace(Vt, en[1] + "//"), f.type = n.method || n.type || f.method || f.type, f.dataTypes = pe.trim(f.dataType || "*").toLowerCase().match(Ae) || [""], null == f.crossDomain && (i = Yt.exec(f.url.toLowerCase()), f.crossDomain = !(!i || i[1] === en[1] && i[2] === en[2] && (i[3] || ("http:" === i[1] ? "80" : "443")) === (en[3] || ("http:" === en[1] ? "80" : "443")))), f.data && f.processData && "string" != typeof f.data && (f.data = pe.param(f.data, f.traditional)), U(Qt, f, n, T), 2 === x)return T;
            u = pe.event && f.global, u && 0 === pe.active++ && pe.event.trigger("ajaxStart"), f.type = f.type.toUpperCase(), f.hasContent = !Gt.test(f.type), a = f.url, f.hasContent || (f.data && (a = f.url += (Bt.test(a) ? "&" : "?") + f.data, delete f.data), f.cache === !1 && (f.url = zt.test(a) ? a.replace(zt, "$1_=" + It++) : a + (Bt.test(a) ? "&" : "?") + "_=" + It++)), f.ifModified && (pe.lastModified[a] && T.setRequestHeader("If-Modified-Since", pe.lastModified[a]), pe.etag[a] && T.setRequestHeader("If-None-Match", pe.etag[a])), (f.data && f.hasContent && f.contentType !== !1 || n.contentType) && T.setRequestHeader("Content-Type", f.contentType), T.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + Kt + "; q=0.01" : "") : f.accepts["*"]);
    ...
    pe.param = function (e, t) {
        ...
        serialize: function () {
            ...
            return this.map(function () {
                ...
                var e = this.type;
                return this.name && !pe(this).is(":disabled") && an.test(this.nodeName) && !on.test(e) && (this.checked || !Ie.test(e))
            }).map(function (e, t) {
                var n = pe(this).val();
    ...
    pe.ajaxSetup({
        ...
        return s || "jsonp" === t.dataTypes[0] ? (i = t.jsonpCallback = pe.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(dn, "$1" + i) : t.jsonp !== !1 && (t.url += (Bt.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function () {
    ...
    var e, t, n, r, i, o, a, s, l, u, c, d, f, p, h, m, g, v, y, b, x, w, T, E, C, k, S, N, j, A, D, L, H, _, q, F, R, O, M, P, I, B, W, $, z, X, U, G, V, Y, Q, J, K, Z, ee, te, ne = [].indexOf || function (e) {
        ...
        for (var r in t)ie.call(t, r) && (e[r] = t[r]);
        return n.prototype = t.prototype, e.prototype = new n, e.__super__ = t.prototype, e
    }, ie = {}.hasOwnProperty, oe = [].slice, ae = function (e, t) {
        return function () {
            return e.apply(t, arguments)
        }
    };
    _ = {}, f = 10, J = !1, M = null, y = null, L = null, B = null, te = null, r = {
        ...
        var t;
        return e = new n(e), U(), d(), null != M && M.start(), J && (t = K(e.absolute)) ? (C(t), k(e, null, !1)) : k(e, Y)
    }, K = function (e) {
        var t;
        return t = _[e], t && !t.transitionCacheDisabled ? t : void 0
    }, x = function (e) {
        return null == e && (e = !0), J = e
    }, b = function (e) {
        return null == e && (e = !0), u ? e ? null != M ? M : M = new o("html") : (null != M && M.uninstall(), M = null) : void 0
    }, k = function (e, t, n) {
        return null == n && (n = !0), Z(r.FETCH, {url: e.absolute}), null != te && te.abort(), te = new XMLHttpRequest, te.open("GET", e.withoutHashForIE10compatibility(), !0), te.setRequestHeader("Accept", "text/html, application/xhtml+xml, application/xml"), te.setRequestHeader("X-XHR-Referer", B), te.onload = function () {
            var n;
            return Z(r.RECEIVE, {url: e.absolute}), (n = O()) ? (W(e), $(), p.apply(null, T(n)), H(), "function" == typeof t && t(), Z(r.LOAD)) : document.location.href = v() || e.absolute
        }, M && n && (te.onprogress = function () {
            return function (e) {
                var t;
        ...
        return null != te && te.abort(), p(e.title, e.body), P(e), Z(r.RESTORE)
    }, d = function () {
        var e;
        ...
        return Z(r.BEFORE_UNLOAD), document.title = t, document.documentElement.replaceChild(n, document.body), null != i && e.update(i), Q(), o && w(), y = window.history.state, null != M && M.done(), Z(r.CHANGE), Z(r.UPDATE)
    }, w = function () {
        ...
        return (e = new n(e)).absolute !== B ? window.history.pushState({
            turbolinks: !0,
            url: e.absolute
        }, "", e.absolute) : void 0
    }, $ = function () {
        ...
        return t = function () {
            ...
            var n, r, i, o, a;
            for (e.length > t.length && (i = [t, e], e = i[0], t = i[1]), o = [], n = 0, r = e.length; r > n; n++)a = e[n], ne.call(t, a) >= 0 && o.push(a);
            return o
        }, !t() && o() && (n = g(te.responseText), n && !e(n)) ? n : void 0
    }, T = function (t) {
        var n;
        ...
        return re(t, e), t.HTML_EXTENSIONS = ["html"], t.allowExtensions = function () {
            var e, n, r, i;
            for (n = 1 <= arguments.length ? oe.call(arguments, 0) : [], r = 0, i = n.length; i > r; r++)e = n[r], t.HTML_EXTENSIONS.push(e);
        ...
        function e(e) {
            this.event = e, this.event.defaultPrevented || (this._extractLink(), this._validForTurbolinks() && (q(this.link.absolute) || ee(this.link.href), this.event.preventDefault()))
        }
        ...
        var t, r;
        return (null != (r = e.state) ? r.turbolinks : void 0) ? (t = _[new n(e.state.url).absolute]) ? (d(), C(t)) : ee(e.target.location.href) : void 0
    }, N = function () {
    ...
    }, S = void 0 !== window.history.state || navigator.userAgent.match(/Firefox\/2[6|7]/), l = window.history && window.history.pushState && window.history.replaceState && S, a = !navigator.userAgent.match(/CriOS\//), V = "GET" === (I = R("request_method")) || "" === I, u = l && a && V, s = document.addEventListener && document.createEvent, s && (j(), D()), u ? (ee = E, N()) : ee = function (e) {
...
(function () {
    jQuery(function () {
        return PrivatePub.subscribe("/posts", function (e) {
            return $("#notification").append("<a href=/posts/" + e.post._id.$oid + ">" + e.post.name + "</a></br>")
        })
    })
}).call(this);